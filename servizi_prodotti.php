...
<body>
<br>
<form method="POST" action="modificaProdServ.php">
    <h3>Scegli prodotto/servizio da modificare: </h3>
    <select name="cmbProdServ">
        <?php
    ...
    <input type="submit" value="MODIFICA PRODOTTO/SERVIZIO" />  
</form>
<br>
<form method="POST" action="delProdServ.php">
    <h3>Scegli prodotto/servizio da eliminare: </h3>
    <h5>Possibilità di eliminare solo prodotti/servizi che non sono in relazione con altre entità</h5>
    <select name="cmbProdServ">
        <?php
            include_once "connessione.php";	
            $Query="SELECT ID_serv_prod, nome_prod_serv FROM servizi_prodotti;"; 
    ...
    <input type="submit" value="ELIMINA PRODOTTO/SERVIZIO" />  
</form>
<br>
